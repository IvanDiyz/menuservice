...
export default function Menuitem({ triger }) {
        ...
        <div className={s.menuitem__popupInform}>
          ...
          >
            <div className={s.menuitem__info_box}>
              <p className={s.menuitem__name}>Піца 4 сири</p>
              <p className={s.menuitem__price}>275 ₴</p>
            </div>
          ...
          <div className={s.menuitem__additives}>
            ...
            <div className={s.menuitem__textareaBox}>
              <textarea className={s.textarea} placeholder="Коментар до кухні..."></textarea>
            </div>
          </div>
        </div>
      </Popup>
