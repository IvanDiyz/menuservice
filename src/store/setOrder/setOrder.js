...
export const { setPaymentMethod, setDelivery, clearItems, changeChoice, changeQuantity, addDish, deleteDish, giveTips, addonsQuantity, addAddons, deleteAddons, addBasket, clearState } = setOrder.actions;
